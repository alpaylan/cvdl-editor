...
function App() {
  ...
  const [storage, setStorage] = useState<Storage>(new RemoteStorage("http://127.0.0.1:8000"));
  ...
  const [renderTarget, setRenderTarget] = useState<"pdf" | "img">("pdf");
  ...
  }, [resume, fontDict, debug, storage, renderTarget, resumeData]);
    ...
    <div style={{ display: "flex", flexDirection: "row" }}>
      <div style={{ display: "flex", width: "700px" }}>
        <div style={{ display: "flex", flexDirection: "column" }}>
          <button onClick={() => setResume("resume2")} >Set resume 2</button>
          <button onClick={() => setResume("resume4")} >Set resume 4</button>
